...
export type RuleType = 'any' | 'array' | 'boolean' | 'date' | 'email' | 'enum' | 'float' | 'hex' | 'integer' | 'method' | 'number' | 'object' | 'pattern' | 'regexp' | 'string' | 'url';
...
type ValidateMessage<T extends any[] = unknown[]> = ((...args: T) => string) | string;
...
export interface RuleItem {
    asyncValidator?: (rule: InternalRuleItem, value: Value, callback: (error?: Error | string) => void, source: Values, options: ValidateOption) => Promise<void> | void;
    defaultField?: Rule;
    ...
    type?: RuleType;
    validator?: (rule: InternalRuleItem, value: Value, callback: (error?: Error | string) => void, source: Values, options: ValidateOption) => SyncValidateResult | undefined;
    whitespace?: boolean;
}
export {};
