...
class SplitterRootContext {
    ...
    constructor() {
        ...
        this.getLimitSize = (str, defaultLimit) => {
            if (utils.isPct(str)) {
                return this.ptg2px(utils.getPct(str));
            }
        ...
        this.updatePercentSizes = () => {
            ...
            for (let i = 0; i < this.panels.length; i += 1) {
                ...
                if (utils.isPct(itemSize)) {
                    ptgList[i] = utils.getPct(itemSize);
                }
                else if (utils.isPx(itemSize)) {
                    ptgList[i] = utils.getPx(itemSize) / this.containerSize;
                }
...
const ns = useNamespace.useNamespace('splitter');
const ZaneSplitter = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.collapseEvent = index.createEvent(this, "collapse", 7);
        this.resizeEndEvent = index.createEvent(this, "zResizeEnd", 7);
        this.resizeEvent = index.createEvent(this, "zResize", 7);
        this.resizeStartEvent = index.createEvent(this, "zResizeStart", 7);
    ...
    componentWillLoad() {
        ...
        utils.splitterRootContexts.set(this.el, this.rootContext);
    }
    disconnectedCallback() {
        this.rootContext = null;
        utils.splitterRootContexts.delete(this.el);
    }
    handleLayoutChange() {
        this.rootContext.layout = this.layout;
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '75149a66180b5169fc8f622dfe00d23071eee1ae', class: [ns.b(), ns.e(this.layout)].join(' '), style: splitterStyles }, index.h("slot", { key: 'd5876da316acb62a7686e11871643809eb28e582' }), this.movingIndex && (index.h("div", { key: 'd904b16e57318ec41807b1ca89c09f6cc122c811', class: [ns.e('mask'), ns.e(`mask-${this.layout}`)].join(' ') }))));
    }
...
exports.zane_splitter = ZaneSplitter;
