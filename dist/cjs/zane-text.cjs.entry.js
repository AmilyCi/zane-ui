...
const ns = useNamespace.useNamespace('text');
const ZaneText = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c09680b49d35a9a599f23e8032c4b40e6f542817', class: textKls, style: { '-webkit-line-clamp': this.lineClamp } }, index.h("slot", { key: '984fe274bf0456e6edad2b9c10acda347842dbff' })));
    }
    bindTitle() {
        if (this.el.title) {
            return;
