...
const ZaneScrollbar = class {
    constructor(hostRef) {
        ...
        this.endReachedEvent = index.createEvent(this, "end-reached", 7);
        this.scrollEvent = index.createEvent(this, "zScroll", 7);
        this.distance = 0;
    ...
    componentWillLoad() {
        ...
        scrollbar.scrollbarContexts.set(this.el, this.context);
    }
    async handleScroll() {
        var _a;
        if (this.wrapRef) {
    ...
    render() {
        ...
        const wrapStyle = normalizeStyle.normalizeStyle(this.wrapStyle);
        if (this.height) {
            wrapStyle.height = addUnit.addUnit(this.height);
        }
        if (this.maxHeight) {
            wrapStyle.maxHeight = addUnit.addUnit(this.maxHeight);
        }
        return (index.h(index.Host, { key: 'f6bbfe1896623897ca691e8e8ffdd0ddc7d4e034', class: ns.b() }, index.h("div", { key: 'c8c12eb40e20e9c883f9a50d359cd263731d19fb', class: wrapKls, onScroll: this.onScrollHandler, ref: (el) => (this.wrapRef = el), style: wrapStyle, tabindex: this.el.tabIndex }, index.h("div", { key: '29034af042633e572399e36fb0e1f042a4125ad6', class: resizeKls, id: this.el.id, ref: (el) => (this.resizeRef = el), role: this.role, style: this.viewStyle }, index.h("slot", { key: 'e6d68794cb2944b3748d5bbabae3d09c983286bd' }))), index.h("zane-bar", { key: '0ffa1e42753ec1c13c647c5faf5d3a8af36a9336', always: this.always, "min-size": this.minSize, ref: (el) => (this.barRef = el) })));
    }
...
exports.zane_scrollbar = ZaneScrollbar;
