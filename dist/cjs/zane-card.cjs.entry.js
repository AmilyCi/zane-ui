...
const ns = useNamespace.useNamespace('card');
const ZaneCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: '36edc2178e7664e874357dceba58a14b566798bb' }, index.h("div", { key: 'a7a507b4cfa0d989154baa80eda7e92845ca7712', class: [
                ns.b(),
                ns.is(`${this.shadow || uuid.state.configProviderContext.card.shadow || 'always'}-shadow`),
            ].join(' ') }, (this.hasHeaderContent || this.header) && (index.h("div", { key: '28c0e2ffe27ce4e1b0867d27aa81af2746c7d41d', class: [ns.e('header'), this.headerClass].join(' ') }, index.h("slot", { key: '743f22be327bb95df80dcd4f89d6aced4ba63635', name: "header" }, this.header))), index.h("div", { key: '72643bb0417a91a1cc2d73eac6513a8d3cec6ca1', class: [ns.e('body'), this.bodyClass].join(' '), style: this.bodyStyle }, index.h("slot", { key: '79477d065273442a648a3dde7248a54fe1c00007' })), (this.hasFooterContent || this.footer) && (index.h("div", { key: '7adb1ea92144efbd189b0bb7bf913f6802f11aca', class: [ns.e('footer'), this.footerClass].join(' ') }, index.h("slot", { key: '011b7417d19e8379b25b4f98aaef1dcc2136ead6', name: "footer" }, this.footer))))));
    }
    get el() { return index.getElement(this); }
};
ZaneCard.style = zaneCardCss();

exports.zane_card = ZaneCard;
