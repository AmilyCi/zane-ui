...
const ZaneButtonGroup = class {
    ...
    componentWillLoad() {
        ...
        button.buttonGroupContexts.set(this.el, context);
    }
    disconnectedCallback() {
        button.buttonGroupContexts.delete(this.el);
    }
    handleWatchSize() {
        var _a;
        (_a = button.buttonGroupContexts.get(this.el)) === null || _a === void 0 ? void 0 : _a.updateSize(this.size);
    }
    handleWatchType() {
        var _a;
        (_a = button.buttonGroupContexts.get(this.el)) === null || _a === void 0 ? void 0 : _a.updateType(this.type);
    }
    render() {
        return (index.h(index.Host, { key: '6b491f3fecc8d986cbfa230c1377eaac81aca00e', class: ns.b('group') }, index.h("slot", { key: '6837edee828aa978c97353e5cc20f800c4a709e7' })));
    }
...
exports.zane_button_group = ZaneButtonGroup;
