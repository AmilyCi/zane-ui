...
var debounce = require('./debounce-BCWnjwam.js');
require('./isString-D2n3i_b0.js');
require('./toObjectString-rn-pSGT_.js');

const isAndroid = () => isClient.isClient && /android/i.test(window.navigator.userAgent);
...
const ns = useNamespace.useNamespace('autocomplete');
...
const ZaneComplete = class {
    constructor(hostRef) {
        ...
        this.selectEvent = index.createEvent(this, "zSelect", 7);
        this.autosize = false;
        ...
        this.zTabindex = 0;
        this.debouncedGetData = debounce.debounce(this.getData, this.debounce);
        this.ignoreFocusEvent = false;
        this.listboxId = uuid.buildUUID();
        this.readonly = false;
    ...
    async getData(queryString) {
        ...
        const cb = (suggestionList) => {
            ...
            if (isArray(suggestionList)) {
                ...
                error.throwError(SCOPE, 'autocomplete suggestions must be an array');
            }
        };
        this.loading = true;
    ...
    render() {
        return (index.h(index.Host, { key: '52a7621e97a06ea631ed7b55548a4fdfd00470e6' }, index.h("zane-tooltip", { key: '2601cf2059a12661554c82b6277e574e9c2627fc', appendTo: this.appendTo, arrow: false, hideOnClick: false, interactive: true, maxWidth: this.dropdownWidth, offset: [0, 1], onZClickOutside: this.handleClickOutside, onZHide: this.handleHide, onZShow: this.handleShow, placement: this.placement, ref: (el) => (this.popperRef = el), role: "listbox", theme: this.popperTheme, trigger: "manual" }, index.h("div", { key: 'aaa415eec77a3e4bdcd1b3693d3ec881ed2deda6', class: {
            ...
            } }, index.h("zane-input", { key: 'd15a21583e240e827b6233b6ec03632dc103ace8', ariaLabel: this.ariaLabel, autosize: this.autosize, clearable: this.clearable, clearIcon: this.clearIcon, disabled: this.getInputDisabled(), form: this.form, formatter: this.formatter, inputStyle: this.inputStyle, max: this.max, maxLength: this.maxLength, min: this.min, minLength: this.minLength, name: this.name, onKeyDown: this.handleKeydown, onZBlur: this.handleBlur, onZChange: this.handleChange, onZClear: this.handleClear, onZFocus: this.handleFocus, onZInput: this.handleInput, parser: this.parser, placeholder: this.placeholder, prefixIcon: this.prefixIcon, readonly: this.readonly, ref: (el) => (this.inputRef = el), resize: this.resize, rows: this.rows, showPassword: this.showPassword, showWordLimit: this.showWordLimit, size: this.size, step: this.step, suffixIcon: this.suffixIcon, type: this.type, validateEvent: this.validateEvent, value: this.value, wordLimitPosition: this.wordLimitPosition, zInputMode: this.zInputMode, zTabindex: this.zTabindex }, index.h("slot", { key: 'ff1d195faed4420e8f494b3a06bd3ea01bdd287d', name: "prepend", slot: "prepend" }), index.h("slot", { key: '6f39bf97a68555129a5a27c38009d517bcada971', name: "append", slot: "append" }), index.h("slot", { key: '3968fb8798a6543b7656fbe9af0e4728840b43f8', name: "prefix", slot: "prefix" }), index.h("slot", { key: '830b56e826a086f4d9760477c889d351bae27502', name: "suffix", slot: "suffix" }))), index.h("div", { key: '2380801ac5a64e9a29ec7812b2bb50012b116dc2', slot: "content" }, index.h("div", { key: '23e1f1e320f39579542d53ed625d7f1ad913004a', class: {
                [ns.b('suggestion')]: true,
                [ns.is('loading', !this.hideLoading && this.loading)]: true,
            }, ref: (el) => (this.regionRef = el), role: "region", style: {
                outline: 'none',
                [this.fitInputWidth ? 'width' : 'minWidth']: this.dropdownWidth,
            } }, this.hasHeader && (index.h("div", { key: '3014d7eee62dc32a06fb9bf920a6301be5edec0c', class: ns.be('suggestion', 'header'), onClick: (e) => e.stopPropagation() }, index.h("slot", { key: '4eaee070c7273cab598c540ffc2d274b222d76e9', name: "header" }))), index.h("zane-scrollbar", { key: 'e05033d087c5ce514c64bab3319f32d018eb4834', id: this.listboxId, role: "listbox", viewClass: ns.be('suggestion', 'list'), wrapClass: ns.be('suggestion', 'wrap') }, index.h("ul", { key: '8c23cf381478416a8af161140324b09bc3daabad' }, !this.hideLoading && this.loading ? (index.h("li", { id: `${this.listboxId}-loading` }, this.loadingRender ? (this.handleLoadingRender()) : (index.h("zane-icon", { class: ns.is('loading'), name: "loading", spin: true })))) : (this.handleSuggestionsRender(this.suggestions)))), this.hasFooter && (index.h("div", { key: '94f78d37a425c93494f757f366c971daf29463ad', class: ns.be('suggestion', 'footer'), onClick: (e) => e.stopPropagation() }, index.h("slot", { key: '767209e0347c4f5d37a056affc13e257464e301a', name: "footer" }))))))));
    }
    getInputDisabled() {
        var _a, _b, _c;
    ...
    handleSuggestionsRender(suggestions) {
        return suggestions.map((item, index$1) => (index.h("li", { "aria-selected": this.highlightedIndex === index$1, class: {
                highlighted: this.highlightedIndex === index$1,
            }, id: `${this.listboxId}-item-${index$1}`, key: `${this.listboxId}-item-${index$1}`, onClick: () => this.handleSelect(item), role: "option" }, this.suggestionRender
            ? this.handleSuggestionItemRender(item, index$1)
            : item[this.valueKey])));
    }
...
exports.zane_autocomplete = ZaneComplete;
