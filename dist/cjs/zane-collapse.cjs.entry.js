...
const isPromise = (val) => {
    return ((isObject.isObject(val) || isFunction(val)) &&
        isFunction(val.then) &&
...
const ZaneCollapse = class {
    constructor(hostRef) {
        ...
        this.zaneChange = index.createEvent(this, "zChange", 7);
        this.zaneUpdate = index.createEvent(this, "zUpdate", 7);
        ...
        this.handleItemClick = async (name) => {
            ...
            if (isPromise(shouldChange)) {
                shouldChange
                    ...
                    .catch((error$1) => {
                    error.debugWarn(SCOPE, `some error occurred: ${error$1}`);
                });
            }
    ...
    componentWillLoad() {
        ...
        collapse.collapseContexts.set(this.el, context);
    }
    disconnectedCallback() {
        collapse.collapseContexts.delete(this.el);
    }
    onModelValueChange() {
        var _a;
        this.activeNames = castArray(this.value);
        (_a = collapse.collapseContexts.get(this.el)) === null || _a === void 0 ? void 0 : _a.updateActiveNames(this.activeNames);
    }
    render() {
        return (index.h(index.Host, { key: '5e22fe183f769df905cb68338143bfaf2209a6a3', class: this.rootKls }, index.h("slot", { key: '0110b8b8a254d2ab45c9e3583e8b4f7b0a51e029' })));
    }
...
exports.zane_collapse = ZaneCollapse;
