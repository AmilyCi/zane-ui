import { r as registerInstance, e as createEvent, h, H as Host, a as getElement, F as Fragment } from './index-B2_qc6fD.js';
...
import { f as formContexts, a as formItemContexts } from './constants-DPmqmB4-.js';
import '@zanejs/icons';
...
import { i as isObject$1, b as baseGetTag, r as root, d as debounce$1 } from './debounce-BnmERUdf.js';
...
const ns$4 = useNamespace('cascader');
const nsInput$1 = useNamespace('input');
const ZaneCascader = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.blurEvent = createEvent(this, "zBlur", 7);
        this.clearEvent = createEvent(this, "zClear", 7);
        this.compositionendEvent = createEvent(this, "zCompositionEnd", 7);
        this.compositionstartEvent = createEvent(this, "zCompositionStart", 7);
        this.compositionupdateEvent = createEvent(this, "zCompositionUpdate", 7);
        this.focusEvent = createEvent(this, "zFocus", 7);
        this.visibleChangeEvent = createEvent(this, "visibleChange", 7);
...
const ZaneIcon = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ab0cece39bb8e64789ed6614e659114e24dd4e58', class: ns$3.b() }, h(IconName, { key: '5def34d8c619f4be0f352bd1043a90b718fe1e71', class: classNameFun(this.classNames, ns$3.is('spin', this.spin)), style: style })));
    }
};
...
const ZaneInput = class {
    constructor(hostRef) {
        ...
        this.keydownEvent = createEvent(this, "zKeyDown", 7);
        this.mouseEnterEvent = createEvent(this, "zMouseEnter", 7);
        this.mouseLeaveEvent = createEvent(this, "zMouseLeave", 7);
...
const ns$2 = useNamespace('tag');
const ZaneTag = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.clickEvent = createEvent(this, "zClick", 7);
        this.closeEvent = createEvent(this, "zClose", 7);
        this.effect = 'light';
        this.type = 'primary';
        this.handleClick = (event) => {
...
const ns$1 = useNamespace('tooltip');
let idCounter = 1;
...
function createTippy(reference, passedProps) {
    ...
    let onFirstUpdate;
    let listeners = [];
    let debouncedOnMouseMove = debounce$1(onMouseMove, props.interactiveDebounce);
    let currentTarget;
    // ===========================================================================
    // 🔑 Public members
    // ===========================================================================
...
const ZaneTooltip = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.zaneClickOutside = createEvent(this, "zClickOutside", 7);
        this.zaneHidden = createEvent(this, "zHidden", 7);
        this.zaneHide = createEvent(this, "zHide", 7);
        this.zaneMount = createEvent(this, "zMount", 7);
        this.zaneShow = createEvent(this, "zShow", 7);
        this.allowHTML = true;
...
export { ZaneCascader as zane_cascader, ZaneIcon as zane_icon, ZaneInput as zane_input, ZaneTag as zane_tag, ZaneTooltip as zane_tooltip };
