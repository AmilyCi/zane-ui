import { r as registerInstance, e as createEvent, h, a as getElement } from './index-B2_qc6fD.js';
...
const ElFocusTrap = class {
    constructor(hostRef) {
        ...
        this.zaneFocusAfterReleased = createEvent(this, "zFocusAfterReleased", 7);
        this.zaneFocusAfterTrapped = createEvent(this, "zFocusAfterTrapped", 7);
        this.zaneFocusin = createEvent(this, "zFocusIn", 7);
        this.zaneFocusout = createEvent(this, "zFocusOut", 7);
        this.zaneFocusoutPrevented = createEvent(this, "zFocusOutPrevented", 7);
        this.zaneReleaseRequested = createEvent(this, "zReleaseRequested", 7);
...
export { ElFocusTrap as zane_focus_trap };
