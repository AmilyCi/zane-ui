...
import type { OptionType, SelectProps, SelectStates, Option, SelectContext } from './types';
...
import { debugWarn, getEventCode, hasRawParent, inLabel, isFocusable, isFunction, isKorean, isNumber, isObject, isUndefined, nextFrame } from '../../utils';
...
@Component({
  tag: 'zane-select-virtual',
  styleUrl: 'zane-select-virtual.scss'
})
export class ZaneSelectVirtual {
  ...
  private calculatePopperSize = () => {
    ...
    const width = this.selectRef?.offsetWidth || 200;
